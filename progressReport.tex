...
velocity profiles:
	-	adapt law of the wall to include -DU term
	-	Generally roughness has the effect of shifting the profile towards the wall, without changing log-law gradient.
	-	Also has no effect on outer region of boundary layer - only inner
	-	However - some types of roughness actually reduce drag - in these cases the velocity profiles move away from the wall and the gradients can change. 
	*** k type and p type roughness ?! ****
