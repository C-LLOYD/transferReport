...
Most engineering and atmospheric flows are bounded by one or many surfaces. These take the form of external flows, such as the flow around cars and aircraft, and internal flows, such as through pipes and channels \citep{pope2001}. Boundary layers arise from the interaction between a fluid as it passes over a surface, whereby the surface-parallel fluid velocity converges to zero as the distance to the wall decreases. This is illustrated by Figure \ref{figure:literatureReview:boundaryLayerRegions}, which splits the wall-parallel velocity into several different regions.
%
\begin{figure}[!b]
\centering
