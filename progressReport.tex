...
\begin{figure}[!b]
\centering
\includegraphics[width=12cm]{Scales2.png}
...
\begin{figure}[!b]
\centering
\includegraphics[width=6cm]{Scale_Replication_1.PNG}\hfill
...
\begin{figure}[!b]
\centering
\vcenteredhbox{\includegraphics[width=12cm]{cross_section_sketch.PNG}}
...
\begin{figure}[!t]
\centering
\vcenteredhbox{\includegraphics[width=7.8cm]{Scale_Replication_3.PNG}}\hfill
\vcenteredhbox{\includegraphics[width=7.8cm]{Scale_Replication_9.PNG}}
...
\begin{figure}[!b]
\centering
\vcenteredhbox{\includegraphics[width=7cm]{Scale_Replication_10.PNG}}\hfill
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_11.PNG}}
...
\begin{figure}[!t]
\centering
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_15.PNG}}\hfill
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_11.PNG}}
\\
\vspace{2cm}
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_16.PNG}}\hfill
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_12.PNG}}
\\
\vspace{3cm}
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_14.PNG}}\hfill
\vcenteredhbox{\includegraphics[width=7.5cm]{Scale_Replication_13.PNG}}
...
\begin{figure}[!t]
\centering
\includegraphics[width=7.5cm]{array_progress_report.PNG}
...
\begin{figure}[!b]
\centering
\includegraphics[width=12cm]{starccm_periodic_mesh.png}
...
\begin{figure}[!t]	
\centering
\includegraphics[width=0.5\textwidth]{Mean_Vel_linear.png}\hfill
\includegraphics[width=0.5\textwidth]{Mean_Vel_log.png}
...
\begin{figure}[!b]
\centering
\includegraphics[width=0.5\textwidth]{rms_u.png}\hfill
\includegraphics[width=0.5\textwidth]{rms_v.png}\\
\includegraphics[width=0.5\textwidth]{rms_w.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{Reynolds_Stress.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{rms_omega_x.png}\hfill
\includegraphics[width=0.5\textwidth]{rms_omega_y.png}\\
\includegraphics[width=0.5\textwidth]{rms_omega_z.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{S_u.png}\hfill
\includegraphics[width=0.5\textwidth]{S_v.png}\\
\includegraphics[width=0.5\textwidth]{S_w.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{F_u.png}\hfill
\includegraphics[width=0.5\textwidth]{F_v.png}\\
\includegraphics[width=0.5\textwidth]{F_w.png}
...
\newpage
\bibliography{../../literature/litReview/literature.bib}
\end{document}
